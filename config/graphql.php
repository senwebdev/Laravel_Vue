...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                App\GraphQL\Query\User::class,
                App\GraphQL\Query\Users::class,
                App\GraphQL\Query\Settings::class
            ],
            'mutation' => [
                App\GraphQL\Mutation\User\Login::class
            ],
//            'secret' => [
//                'query' => [
//                    //'mySecretQuery' => '......'
...
//                'secret' => ['auth:api'],
    ...
    'types' => [
        ...
        App\GraphQL\Type\InputObject\User::class,
        App\GraphQL\Type\Roles::class,
        App\GraphQL\Type\InputObject\Roles::class,
        App\GraphQL\Type\Permissions::class,
        App\GraphQL\Type\InputObject\Permissions::class,
        App\GraphQL\Type\Settings::class,
        App\GraphQL\Type\InputObject\Settings::class
    ],
